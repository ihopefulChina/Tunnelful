...
const armDownloadURL =
  'https://github.com/ihopefulChina/Tunnelful/releases/download/v0.1.3/Tunnelful-0.1.3-arm64.dmg';
const intelDownloadURL =
  'https://github.com/ihopefulChina/Tunnelful/releases/download/v0.1.3/Tunnelful-0.1.3-x86_64.dmg';
