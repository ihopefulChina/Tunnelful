...
export const armDownloadURL = `${repositoryURL}/releases/download/v${releaseVersion}/Tunnelful-${releaseVersion}-arm64.dmg`;
export const intelDownloadURL = `${repositoryURL}/releases/download/v${releaseVersion}/Tunnelful-${releaseVersion}-x86_64.dmg`;
