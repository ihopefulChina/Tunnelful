...
- 官网视觉参考：`../website/public/tunnelful-window-v0.1.10.png` / `../website/public/tunnelful-window-dark-v0.1.10.png`
- 0.1.13 沿用的官网 macOS 26 外观基准：`../website/public/tunnelful-window-v0.1.10.png` / `../website/public/tunnelful-window-dark-v0.1.10.png`
...
- 发布边界：0.1.13 窗口外壳未改，沿用 0.1.10 截图；保存后的 DNS 确认与 Tunnel 重启/启动询问属于行为变化。正式 DMG 必须由 Xcode 26 / macOS 26 SDK 构建，并在 macOS 26 上从安装包复核侧栏
