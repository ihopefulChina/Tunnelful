...
- 0.1.12 沿用的官网 macOS 26 外观基准：`../website/public/tunnelful-window-v0.1.10.png` / `../website/public/tunnelful-window-dark-v0.1.10.png`
...
- 发布边界：0.1.12 窗口外壳未改，沿用 0.1.10 截图；概览启动中按钮与登录等待地址属于行为变化。正式 DMG 必须由 Xcode 26 / macOS 26 SDK 构建，并在 macOS 26 上从安装包复核侧栏
