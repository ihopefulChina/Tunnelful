...
- 0.1.15 沿用的官网 macOS 26 外观基准：`../website/public/tunnelful-window-v0.1.10.png` / `../website/public/tunnelful-window-dark-v0.1.10.png`
...
- 发布边界：0.1.15 窗口改回系统侧栏和控件背景，官网仍沿用 0.1.10 截图。正式 DMG 必须由 Xcode 26 / macOS 26 SDK 构建，并在 macOS 26 上从安装包复核侧栏
