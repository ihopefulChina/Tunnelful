...
> [!IMPORTANT]
> 当前源码版本为 `0.1.4`，可下载版本及其支持架构以 [GitHub Releases](https://github.com/ihopefulChina/Tunnelful/releases) 中的实际附件为准。目前公开安装包采用 ad-hoc 签名，尚未使用 Developer ID 签名或经过 Apple 公证。
...
| 项目 | 当前支持 |
| --- | --- |
| 当前源码 | `0.1.4`；已发布版本见 [Releases](https://github.com/ihopefulChina/Tunnelful/releases) |
| macOS | macOS 14 或更高版本 |
| `0.1.4` 构建目标 | Apple 芯片 `arm64` 与 Intel `x86_64` 单架构 DMG |
