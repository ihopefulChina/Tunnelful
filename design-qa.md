...
- 官网 0.1.10 深色发布图：`website/public/tunnelful-window-dark-v0.1.10.png`
- 官网 0.1.10 浅色发布图：`website/public/tunnelful-window-v0.1.10.png`
...
- README 与官网的浅色、深色截图均已切换为当前 0.1.10 原生实现；官网发布图与对应 `design/actual-app*.png` 逐字节一致。
